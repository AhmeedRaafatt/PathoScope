  ...
  const fetchAnalytes = async () => {
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/api/admin/analytes/?${params}`,
        {
          headers: {
      ...
      <div className="content-section">
        ...
        <section className="filters-section">
          ...
          <div className="filter-dropdown">
            <FontAwesomeIcon icon={faFlask} className="filter-icon" />
            <select
              value={testFilter}
                  ...
                  analytes.map((analyte) => (
                    <tr key={analyte.id} className="analyte-row">
                      ...
                      <td className="range-cell">
                        {analyte.normal_range_low} - {analyte.normal_range_high}
                      </td>
        ...
        <div className="modal-overlay">
          <div className="modal delete-modal">
            ...
            <div className="modal-body">
              ...
              <p>
                Are you sure you want to delete analyte{" "}
                <strong>{selectedAnalyte.analyte_name}</strong>?
              </p>
...
function AnalyteModal({ title, analyte, onSubmit, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.normal_range_low)
      newErrors.normal_range_low = "Minimum range is required";
    if (!formData.normal_range_high)
      newErrors.normal_range_high = "Maximum range is required";

    if (
      formData.normal_range_low &&
      formData.normal_range_high &&
      parseFloat(formData.normal_range_low) >= parseFloat(formData.normal_range_high)
    ) {
      newErrors.normal_range_high = "Maximum must be greater than minimum";
    }
    ...
    const submissionData = {
      ...formData,
      normal_range_low: parseFloat(formData.normal_range_low),
      normal_range_high: parseFloat(formData.normal_range_high),
    };
      ...
      <div className="modal analyte-modal">
        ...
        <form onSubmit={handleSubmit} className="modal-body">
          <div className="form-group">
            ...
            />
            {errors.test_name && (
              <span className="error-text">{errors.test_name}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.analyte_name && (
              <span className="error-text">{errors.analyte_name}</span>
            )}
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              />
              {errors.normal_range_low && (
                <span className="error-text">{errors.normal_range_low}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.normal_range_high && (
                <span className="error-text">{errors.normal_range_high}</span>
              )}
            </div>
          </div>
